...
public final class StateMachineUtil {
  ...
  private static boolean removeStaleBehaviourTags(
      com.raven.thunder.api.model.UserDataSnapshot snapshot, Set<String> activeBehaviourTags) {
  ...
  public static void mergeDeltaSnapshot(
      com.raven.thunder.api.model.UserDataSnapshot snapshot,
      com.raven.thunder.api.io.request.CTASnapshotRequest deltaSnapshot) {
  ...
  private static void mergeBehaviourTagSnapshots(
      com.raven.thunder.api.model.UserDataSnapshot snapshot,
      List<com.raven.thunder.api.model.BehaviourTagSnapshot> deltaBehaviourTags) {
    if (snapshot.getBehaviourTags() == null) {
      snapshot.setBehaviourTags(new HashMap<>());
    }

    for (com.raven.thunder.api.model.BehaviourTagSnapshot behaviourTagSnapshot :
        deltaBehaviourTags) {
      snapshot
          .getBehaviourTags()
