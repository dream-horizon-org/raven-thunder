...
@Tag(
    name = "SDK",
    description =
        "APIs for SDK clients to interact with Thunder. "
...
public class SdkApiController {
  ...
  @Operation(
      ...
      description =
          "Retrieves a Nudge Preview by its ID. "
  ...
  public CompletionStage<Response<CTAResponse>> appLaunch(
      ...
      @Parameter(
          ...
          @NotNull(message = "auth-userid cannot be null")
          @HeaderParam("auth-userid")
          Long userId,
      @Parameter(
              name = "app_version",
      ...
      @Parameter(
          ...
          @Nullable
          @HeaderParam("package_name")
          String packageName,
      @Parameter(
              name = "api_version",
              description =
                  "API version. Must be >= 1 for the endpoint to process the request. "
                      + "If null or < 1, returns empty response.",
              required = false,
              example = "1",
              schema = @Schema(type = SchemaType.INTEGER, format = "int64"))
          @Nullable
          @HeaderParam("api_version")
          Long apiVersion,
      @RequestBody(
          ...
          @Valid
          CTASnapshotRequest deltaSnapshot) {
  ...
  @Operation(
      ...
      description =
          "Merges a delta snapshot from the client with the server state. "
  ...
  public CompletionStage<Response<Boolean>> merge(
      ...
      @RequestBody(
              description =
                  "Delta snapshot containing updated CTAs and behaviour tags to merge with server state",
              required = true,
              content =
                  @Content(
                      mediaType = MediaType.APPLICATION_JSON,
