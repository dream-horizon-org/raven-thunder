...
class SdkApiIT {
	...
	@Test
	@DisplayName("POST /cta/active/state-machines/ missing auth-userid still returns 200 (no header validation)")
	...
	@Test
	@DisplayName("POST /cta/state-machines/snapshot/delta/ missing auth-userid still returns 200 (no header validation)")
