...
<div className="hero">
  <div className="container">
    ...
    <div className="hero__buttons">
      <a className="button button--primary button--lg" href="/thunder/getting-started/quickstart">
        Get Started
      </a>
      <a className="button button--secondary button--lg" href="/thunder/getting-started/overview">
        Learn More
      </a>
    </div>
  </div>
...
- **[Getting Started](/thunder/getting-started/overview)** - Setup and quickstart guides
- **[Core Entities](/thunder/getting-started/core-entities)** - Understanding CTAs, Behaviour Tags, and Nudges
- **[Architecture](/thunder/architecture/modules)** - System architecture and design
- **[API Documentation](/thunder/api/overview)** - SDK API endpoints and contracts
- **[Admin Documentation](/thunder/admin/overview)** - Admin API endpoints and contracts
- **[Operations](/thunder/operations/docker)** - Docker, testing, CI/CD, and releases
...
<div className="margin-top--lg">
  <p>
    <strong>New to Thunder?</strong> Start with understanding the <a href="/thunder/getting-started/core-entities">Core Entities</a> (CTAs, Behaviour Tags, and Nudges), then check out the <a href="/thunder/getting-started/quickstart">Quickstart</a> guide.
  </p>
</div>
