...
/**
 * Test setup for Thunder Admin:
 * - Starts Aerospike Testcontainer
 * - Configures dynamic HTTP port and RestAssured
 * - Initializes Guice and deploys MainVerticle
 */
public class Setup implements ExtensionContext.Store.CloseableResource, BeforeAllCallback, TestInstancePostProcessor {
	...
	private void initializeGuiceInjector() {
		try {
			com.dream11.thunder.admin.injection.GuiceInjector.initialize(
					java.util.List.of(new com.dream11.thunder.admin.injection.MainModule(vertx.getDelegate())));
	...
	private void startApplication() {
		this.vertx.rxDeployVerticle("com.dream11.thunder.admin.verticle.MainVerticle").blockingGet();
	}
