...
@Tag(
    name = "Behaviour Tags",
    description = "APIs for managing Behaviour Tags. " +
...
public class BehaviourTagController {
  ...
  @Operation(
      ...
      description = "Retrieves a list of all Behaviour Tags for the specified tenant. " +
                    "Behaviour Tags define user segments and their exposure rules for CTAs.",
  ...
  @Operation(
      ...
      description = "Retrieves a specific Behaviour Tag by its name. " +
  ...
  @Operation(
      ...
      description = "Creates a new Behaviour Tag with exposure rules and CTA relations. " +
  ...
  @Operation(
      ...
      description = "Updates an existing Behaviour Tag's description, exposure rules, and CTA relations. " +
