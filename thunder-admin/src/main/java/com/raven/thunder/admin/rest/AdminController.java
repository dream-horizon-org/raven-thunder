...
public class AdminController {
  ...
  @Tag(
      name = "Nudge Previews",
      description =
          "APIs for managing Nudge Previews. "
  ...
  @Operation(
      ...
      description =
          "Creates a new Nudge Preview or updates an existing one if it already exists. "
              + "Nudge Previews are used to preview nudge templates before they are used in CTAs. "
              + "The preview includes the nudge template and TTL (time-to-live) configuration.",
  ...
  @Operation(
      ...
      description =
          "Retrieves a Nudge Preview by its ID. Returns the preview template and TTL configuration.",
  ...
  @APIResponse(responseCode = "404", description = "Nudge Preview not found")
  @GET
  @Path("/nudge/preview/")
  @Produces(MediaType.APPLICATION_JSON)
  ...
  @Tag(
      name = "CTAs",
      description =
          "APIs for managing Call-to-Actions (CTAs). Includes CRUD operations for creating, "
              + "updating, retrieving, and listing CTAs with filtering and pagination support.")
  @Operation(
      summary = "Create CTA",
      description =
          "Creates a new Call-to-Action (CTA) with the provided details. "
  ...
  @APIResponse(
      ...
      content =
          @Content(
              mediaType = MediaType.APPLICATION_JSON,
              schema =
                  @Schema(type = SchemaType.INTEGER, format = "int64", description = "New CTA ID"),
              examples = {
                @ExampleObject(
                    name = "Success Response",
  ...
  public CompletionStage<Response<Long>> createCta(
      ...
      @RequestBody(
              description =
                  "CTA creation request containing name, description, tags, team, rule configuration, "
  ...
  @Operation(
      summary = "Update CTA",
      description =
          "Updates an existing CTA. Only the fields provided in the request will be updated. "
  ...
  @APIResponse(responseCode = "400", description = "Invalid request data or validation failed")
  @APIResponse(responseCode = "404", description = "CTA not found")
  @PUT
  @Path("/ctas/{ctaId}")
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.APPLICATION_JSON)
  public CompletionStage<Response<Object>> updateCta(
      ...
      @RequestBody(
              description =
                  "CTA update request containing fields to update. "
  ...
  @Operation(
      ...
      description =
          "Retrieves a specific CTA by its unique identifier. "
  ...
  @Operation(
      summary = "List CTAs",
      description =
          "Retrieves a paginated list of CTAs matching the specified filters. "
  ...
  @Tag(
      name = "Filters",
      description =
          "APIs for retrieving filter values used in the admin UI. "
              + "Provides available options for tags, teams, statuses, behaviour tags, and creators.")
  @Operation(
      summary = "Get Filters",
      description =
          "Retrieves available filter values for CTAs including tags, teams, statuses, "
  ...
  @Tag(
      name = "CTA Status",
      description =
          "APIs for managing CTA lifecycle status transitions. "
              + "CTAs move through states: DRAFT → SCHEDULED → LIVE → PAUSED → CONCLUDED/TERMINATED.")
  @Operation(
      summary = "Activate CTA",
      description =
          "Changes the CTA status to LIVE. The CTA must be in SCHEDULED or PAUSED status. "
  ...
  @APIResponse(
      responseCode = "400",
      description =
          "CTA cannot be activated from current status. Only SCHEDULED or PAUSED CTAs can be activated.")
  @APIResponse(responseCode = "404", description = "CTA not found")
  @PUT
  @Path("/ctas/{id}/live")
  @Produces(MediaType.APPLICATION_JSON)
  ...
  @Operation(
      summary = "Pause CTA",
      description =
          "Changes the CTA status to PAUSED. The CTA must be in LIVE status. "
  ...
  @Operation(
      ...
      description =
          "Changes the CTA status to SCHEDULED. The CTA must be in DRAFT status. "
  ...
  @APIResponse(
      responseCode = "400",
      description =
          "CTA cannot be scheduled from current status. Only DRAFT CTAs can be scheduled.")
  @APIResponse(responseCode = "404", description = "CTA not found")
  @PUT
  ...
  @Operation(
      ...
      description =
          "Changes the CTA status to CONCLUDED. The CTA must be in LIVE or PAUSED status. "
  ...
  @APIResponse(
      responseCode = "400",
      description =
          "CTA cannot be concluded from current status. Only LIVE or PAUSED CTAs can be concluded.")
  @APIResponse(responseCode = "404", description = "CTA not found")
  @PUT
  ...
  @Operation(
      ...
      description =
          "Changes the CTA status to TERMINATED. The CTA must be in DRAFT, SCHEDULED, LIVE, or PAUSED status. "
  ...
  @APIResponse(
      responseCode = "400",
      description =
          "CTA cannot be terminated from current status. Only DRAFT, SCHEDULED, LIVE, or PAUSED CTAs can be terminated.")
  @APIResponse(responseCode = "404", description = "CTA not found")
  @PUT
