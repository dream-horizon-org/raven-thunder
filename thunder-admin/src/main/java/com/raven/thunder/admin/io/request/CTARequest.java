...
import static com.raven.thunder.admin.constant.Constants.ALLOWED_DIFF_FROM_CURRENT_TIME_IN_MIN;
...
@Schema(
    description =
        "Request to create a new CTA (Call-to-Action). "
...
public class CTARequest {
  @Schema(
      ...
      examples = {"Testing1", "Welcome Bonus"},
      required = true,
      maxLength = 100)
  private String name;
  ...
  @Schema(
      description =
          "Start time in epoch milliseconds. If null, CTA starts immediately when activated.",
  ...
  @Schema(
      description =
          "Rule configuration for the CTA including cohort eligibility, state transitions, "
