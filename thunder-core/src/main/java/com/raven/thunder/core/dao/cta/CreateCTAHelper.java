...
public class CreateCTAHelper {

  public Bin[] apply(String tenantId, @NonNull CTA cta) throws JsonProcessingException {
    ...
    binList.add(new Bin(Schema.BEHAVIOUR_TAG_BIN, new Value.ListValue(cta.getBehaviourTags())));
    ...
    binList.add(new Bin(Schema.TENANT_BIN, new Value.StringValue(tenantId))); // tenantID
