package com.raven.thunder.core.dao.nudge.preview;

import static com.raven.thunder.core.error.ServiceError.NUDGE_PREVIEW_NOT_FOUND_EXCEPTION;
import static com.raven.thunder.core.error.ServiceError.TENANT_NOT_AUTHORISED;
